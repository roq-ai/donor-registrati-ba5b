...
import { getScreeningQuestionById } from 'apiSdk/screening-questions';
...
function ScreeningQuestionViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Screening Question Detail View
          </Text>
          {hasAccess('screening_question', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/screening-questions/edit/${data?.id}`} passHref legacyBehavior>
              <Button
