...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Healthcare Professional'];
  const customerRoles: string[] = ['Prospective Donor'];
  const tenantRoles: string[] = ['Healthcare Professional'];
  const addOns: string[] = ['chat', 'notifications', 'file'];
  const applicationName = `Donor Registration (Outdoor)`;
